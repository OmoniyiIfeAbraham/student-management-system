...
class Theresa extends StatefulWidget {
  const Theresa({Key? key}) : super(key: key);

  @override
  _TheresaState createState() => _TheresaState();
}

class _TheresaState extends State<Theresa> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Ekwonu Theresa'),
          centerTitle: true,
              ...
              Row(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text(
                      '''        Hi, am Ekwonu Theresa, I am a student of Lincoln College 
      ...
      to this project by developing my page.''',
              ...
              Container(
                ...
                child: Text('08056185989'),
              ),
              Container(
                padding: EdgeInsets.fromLTRB(100, 15.0, 0, 0),
                child: Text('ekwonutessy@gmail.com'),
              )
            ],
          ),
        ));
