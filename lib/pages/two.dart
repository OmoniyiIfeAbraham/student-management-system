...
class Dajib extends StatefulWidget {
  const Dajib({Key? key}) : super(key: key);

  @override
  _DajibState createState() => _DajibState();
}

class _DajibState extends State<Dajib> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Dauda Isa Jibril'),
          centerTitle: true,
              ...
              Row(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text(
                      '''        Hi, am Dauda Isa Jibril, I am a student of Lincoln College 
      ...
      to this project by developing my page.''',
              ...
              Container(
                ...
                child: Text('08134081164'),
              ),
              Container(
                padding: EdgeInsets.fromLTRB(100, 15.0, 0, 0),
                child: Text('dajibisa@gmail.com'),
              )
            ],
          ),
        ));
